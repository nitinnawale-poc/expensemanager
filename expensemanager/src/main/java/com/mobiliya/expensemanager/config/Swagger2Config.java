...
.paths(PathSelectors.regex("/expensemanager/.*")).build().apiInfo(apiEndPointsInfo());
}
...
return new ApiInfoBuilder().title("Spring Boot REST API").description("Expense Manager REST API")
