...
/** The logger. */
private Logger logger = LoggerFactory.getLogger(ExpenseDaoImpl.class);
...
@Autowired
private ExpenseObjectConverter expenseConverter;
...
try {
expenseDto = expenseConverter.convertEntityToDto(expenseRepository.save
(expenseConverter.convertDtoToEntity(dto)));
} catch (Exception e) {
