...
public class ExpenseController {
    ...
    public ResponseEntity<List<ExpenseDto>> getExpensesByCategoryName(
        ...
        return new ResponseEntity<List<ExpenseDto>>(service.getExpenses(categoryName), 
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<ExpenseDto>> getExpenseAfterDate(
        ...
        return new ResponseEntity<List<ExpenseDto>>(service.getExpenseAfterDate(date),
                HttpStatus.OK);
    }
    ...
    message = "Started Message Service Successfully"),
